          ...
          <div className="p-6">
            ...
            <div className="flex justify-between items-center">
              <div className="flex flex-wrap gap-2">
                ...
                {quickDates.slice(0, 7).map(date => (
                  <button
                    ...
                    className="px-3 py-1 text-xs bg-gray-100 dark:bg-slate-700 hover:bg-teal-100 dark:hover:bg-teal-900/20 hover:text-teal-700 dark:hover:text-teal-400 rounded transition-colors text-gray-700 dark:text-gray-300"
                  >
              ...
              <button
                ...
                disabled={saving || !newAvailability.date}
                className="flex items-center space-x-2 bg-teal-600 dark:bg-teal-500 text-white px-4 py-2 rounded-lg hover:bg-teal-700 dark:hover:bg-teal-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <FaSave className="w-4 h-4" />
                <span>{saving ? 'Adding...' : 'Add Availability'}</span>
              </button>
            </div>
          </div>
        </div>
                ...
                {availabilities.map((availability) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 px-3 py-2 rounded border border-red-600 dark:border-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                    >
