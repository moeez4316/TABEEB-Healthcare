...
export default function AdminWriteBlogPage() {
  ...
  return (
    <AdminPageShell>
      <AdminPageHeader
        title={showPreview ? 'Blog Preview' : 'Create Blog'}
        subtitle={
          showPreview
            ? 'Review the article before publishing it to the platform.'
            : 'Compose a new article with rich content, metadata, and publishing controls.'
        }
        ...
        actions={
          <div className="flex flex-wrap items-center gap-2">
            <Link
              href="/admin/blogs"
              className="inline-flex items-center gap-2 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 text-sm font-semibold"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 text-sm font-semibold"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-200 dark:bg-slate-700 text-slate-900 dark:text-slate-100 hover:bg-slate-300 dark:hover:bg-slate-600 text-sm font-semibold disabled:opacity-50"
            >
